    ...
    async fetchData() {
      ...
      if (this.fileStore.formKTP?.message && Object.keys(this.fileStore.formKTP.message).length > 0) {
        this.form = {
          ...
          jenisKelamin: this.fileStore.formKTP.message.jenis_kelamin,
          kewarganegaraan: this.fileStore.formKTP.message.kewarganegaraan,
          agama: this.fileStore.formKTP.message.agama,
