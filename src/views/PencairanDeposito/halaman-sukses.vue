<template>
  <form @submit.prevent="handleBack">
    ...
    <p class="text-sm sm:text-md md:text-base text-neutral-900 text-center mb-4">
      Aplikasi Pengajuan Penutupan Deposito Anda Telah Berhasil Dikirim.
    </p>
    ...
    <div class="py-4">
      ...
      <ul class="list-disc pl-8 space-y-2 text-sm sm:text-sm md:text-sm">
        ...
        <li>Pengajuan Penutupan Deposito di atas pukul 12.00 WIB akan diproses pada hari kerja berikutnya.</li>
    ...
    <div class="py-4">
      ...
      <button type="button"
        ...
        <div class="overflow-hidden">
          <p
            ...
            Formulir Pengajuan Penutupan Deposito - {{ namaLengkap }}.zip
          </p>
        </div>
        <div class="">
      ...
      <p class="text-sm my-4">
        Dokumen PDF Formulir Penutupan Deposito yang telah ditandatangani secara digital dapat diunduh di
...
export default {
  data() {
    return {
      // ...
      downloadFileName: 'Formulir Pengajuan Penutupan Deposito - MIRA SETIAWAN.pdf',
    };
  },
  components: {
    ButtonComponent,
  ...
  methods: {
    ...
    async downloadPdf() {
      ...
      try {
        const response = await api.get(`/download-signed-pdf?uuid=${uuid}&form=PencairanDeposito`, {
        ...
        let filename = `Formulir Pengajuan Penutupan Deposito - ${namaLengkap}.zip`;
