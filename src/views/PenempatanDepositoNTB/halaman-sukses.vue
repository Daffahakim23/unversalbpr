  ...
  <form @submit.prevent="handleBack">
    ...
    <div class="py-4">
      ...
      <ul class="list-disc pl-8 space-y-2 text-sm sm:text-sm md:text-sm">
        ...
        <li>Pengajuan Pembukaan Deposito di atas pukul 12.00 WIB akan diproses pada hari kerja berikutnya.</li>
    ...
    <div class="py-4">
      ...
      <p class="text-sm my-4">
        Dokumen PDF Formulir Pembukaan Deposito yang telah ditandatangani secara digital dapat diunduh di
...
export default {
  data() {
    return {
      // ...
      downloadFileName: 'Formulir Pengajuan Pembukaan Deposito - MIRA SETIAWAN.pdf', // Nama default
    };
  },
  components: {
    ButtonComponent,
  ...
  methods: {
    ...
    async downloadPdf() {
      ...
      try {
        const response = await api.get(`/download-signed-pdf?uuid=${uuid}&form=DNTB`, {
