...
<!-- <script>
import { useKTPForm } from "@/Utils/dataKTP.js";
...
export default {
  components: { FormField, ButtonComponent },
  setup() {
    return useKTPForm("/save-ktp-existing", "/dashboard/uploadDokumenPembukaanRekeningExisting");
  },
  data() {
    return {
      form: new FormModelDataKTP(),
      statusPerkawinanOptions,  // Pastikan ini ada
      jenisKelaminOptions,
      agamaOptions,
