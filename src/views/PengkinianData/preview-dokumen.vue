  ...
  setup() {
    ...
    const uploadPhoto = async () => {
      ...
      try {
        ...
        const apiEndpoint =
          documentType.value === "ktp" ? "/ocr-ktp-pengkinian-data" :
            documentType.value === "tandaTangan" ? "/tt-basah-pengkinian-data" :
              documentType.value === "npwp" ? "/npwp-pengkinian-data" : "/foto-diri-pengkinian-data";
  ...
  methods: {
    ...
    async saveFile() {
      try {
        ...
        const apiEndpoint =
          this.documentType === "ktp" ? "ocr-ktp-pengkinian-data" :
            this.documentType === "tandaTangan" ? "tt-basah-pengkinian-data" :
              "npwp-pengkinian-data";
