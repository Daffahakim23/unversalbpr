            ...
            <div class="flex-grow flex flex-col">
                <div class="text-center sm:text-center">
                    <h1
                        ...
                        Selamat Datang Nasabah di Layanan Transfer
                    </h1>
                        ...
                        <div class="flex flex-col sm:flex-row justify-center gap-4 md:gap-8 lg:gap-12">
                            <div class="flex flex-col items-center text-center max-w-[200px] mx-auto">
                                ...
                                <p class="text-sm text-gray-600">
                                    Isi formulir elektronik dengan informasi yang tepat sebagai awal proses Transfer
                                </p>
                            </div>
...
export default {
    ...
    methods: {
        ...
        async startDepositClosure() {
            ...
            this.$router.push({
                path: "/dashboard/formPemindahbukuan",
            });
        },
