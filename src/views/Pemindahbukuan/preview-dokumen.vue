...
export default {
  ...
  setup() {
    ...
    const uploadPhoto = async () => {
      ...
      try {
        ...
        const apiEndpoint =
          documentType.value === "ktp" ? "/ocr-ktp-pindah-buku" : "/foto-diri-pindah-buku";
        ...
        if (documentType.value === "ktp") {
          router.push({
            path: "/dashboard/dataKTPPemindahbukuan",
  ...
  methods: {
    ...
    handleFileNotFound() {
      ...
      this.$router.replace("/dashboard/uploadDokumenPemindahbukuan");
    },
    ...
    async saveFile() {
      ...
      try {
        ...
        const apiEndpoint =
          this.documentType === "ktp" ? "ocr-ktp-pindah-buku" :
            this.documentType === "tandaTangan" ? "tt-basah-pindah-buku" :
              "npwp-pindah-buku";
