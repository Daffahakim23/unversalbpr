    ...
    <div class="relative flex flex-col items-left mb-6 w-full">
        ...
        <div class="flex flex-row mt-2 w-full">
            <button type="button" @click="decrement"
                class=" text-primary bg-primary-50 hover:bg-primary-100 border-neutral-200  border rounded-s-lg p-3 h-10 focus:ring-gray-100  focus:ring-2 focus:outline-none">
            ...
            <input type="text" :id="id" v-model="internalValue" inputmode="numeric"
                class="bg-white border-y border-neutral-200 h-10 text-center text-neutral-900 text-sm focus:ring-primary-300 block w-full py-2.5"
                :maxlength="maxlength" @blur="validateAndEmit" @input="handleInput" />
            <button type="button" @click="increment"
                class=" text-primary bg-primary-50 hover:bg-primary-100 border-neutral-200  border rounded-e-lg p-3 h-10 focus:ring-gray-100  focus:ring-2 focus:outline-none">
